...
class SunoGetStarted extends StatefulWidget {
  const SunoGetStarted({super.key});

  @override
  State<SunoGetStarted> createState() => _SunoGetStartedState();
}

class _SunoGetStartedState extends State<SunoGetStarted> {
  ...
  void _initializeGetStartedData() {
    ...
    getStartedData = [
      GetStartedModel(
        ...
        instructions: [
          ...
          GetStartedInstruction(
            ...
            description:
                "Make sure you can hear audio clearly through your headphones or speakers.",
            iconPath: "assets/icons/support_icon.png",
          ),
          GetStartedInstruction(
      ...
      GetStartedModel(
        ...
        instructions: [
          GetStartedInstruction(
            title: "Listen to complete audio",
            description:
                "Play the entire audio clip before starting to type the transcription.",
            iconPath: "assets/icons/play_icon.png",
          ),
          GetStartedInstruction(
            title: "Type exactly what you hear",
            description:
                "Transcribe the audio word-for-word, including any pauses or repetitions.",
            iconPath: "assets/icons/record_icon.png",
          ),
          GetStartedInstruction(
            title: "Use correct spelling",
            description:
                "Ensure proper spelling and grammar in your transcription.",
                      ...
                      onTap: () {
                        if (_currentPage == 0) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const SunoContribute(),
                            ),
                          );
                        }
                      },
