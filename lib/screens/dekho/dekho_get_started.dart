...
class DekhoGetStarted extends StatefulWidget {
  const DekhoGetStarted({super.key});

  @override
  State<DekhoGetStarted> createState() => _DekhoGetStartedState();
}

class _DekhoGetStartedState extends State<DekhoGetStarted> {
                      ...
                      onTap: () {
                        if (_currentPage == 0) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const DekhoContribute(),
                            ),
                          );
                        }
                      },
