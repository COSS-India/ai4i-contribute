...
class ApiUrl {
  ...
  static final String getSentancesForRecordingUrl = '$baseUrl/bolo/queue';
  static final String sumbitAudioUrl = '$baseUrl/bolo/submit';
  static final String reportIssueUrl = '$baseUrl/bolo/report';
  static final String contributeSessionCompleteUrl =
      '$baseUrl/bolo/session-complete';
  ...
  static final String skipContributionUrl = '$baseUrl/bolo/contributions/skip';
  static final String getValidationsQueUrl = '$baseUrl/bolo/validation';
  static final String submitValidationUrl =
      '$baseUrl/validations/submit-correction';
  ...
  static final String likhoValidationCorrectUrl =
      '$baseUrl/likho/validation/correct';
  static final String likhoValidationCorrectionUrl =
      '$baseUrl/likho/validation/submit-correction';
  ...
  static final String dekhoValidationCorrectUrl =
      '$baseUrl/dekho/validation/correct';
  static final String dekhoValidationCorrectionUrl =
      '$baseUrl/dekho/validation/submit-correction';
  ...
  static final String sunoValidationCorrectUrl =
      '$baseUrl/suno/validation/correct';
