...
void main(List<String> arguments) async {
  ...
  try {
    ...
    final environments = Map<String, dynamic>.from(config['environments'] ?? {});
    final envConfig = Map<String, dynamic>.from(environments[environment] ?? {});
...
Future<void> configureAndroid(String displayName, String packageId, String environment) async {
...
Future<void> updateAppIcon(Map<String, dynamic> config) async {
  ...
  if (pubspecFile.existsSync()) {
    ...
    content = content.replaceAll(
      RegExp(r'image_path_android: "[^"]*"'),
      'image_path_android: "$finalIconPath"'
    );
    content = content.replaceAll(
      RegExp(r'image_path_ios: "[^"]*"'),
      'image_path_ios: "$finalIconPath"'
    );
